...
import { Fragment, ReactNode, SVGProps, useId } from 'react'
 ...
 */
export const ArrowDownSvgImage = (rest: SharedSvgImageProps) => {
  return (
    <SharedSvgImage
      viewBox="0 0 16 16"
      fill="none"
 ...
 */
export const ArrowLeftSvgImage = (rest: SharedSvgImageProps) => {
  return (
    <SharedSvgImage
      viewBox="0 0 16 16"
      fill="none"
 ...
 */
export const BriefcaseSvgImage = (rest: SharedSvgImageProps) => {
  return (
    <SharedSvgImage
      viewBox="0 0 24 24"
      fill="none"
 ...
 */
export const ChevronDownSvgImage = (rest: SharedSvgImageProps) => {
  return (
 ...
 */
export const ChevronRightSvgImage = (rest: SharedSvgImageProps) => {
  return (
    <SharedSvgImage
      viewBox="0 0 16 16"
      fill="none"
 ...
 */
export const CloseSvgImage = (rest: SharedSvgImageProps) => {
  return (
 ...
 */
export const GitHubSvgImage = (rest: SharedSvgImageProps) => {
  return (
    <SharedSvgImage viewBox="0 0 24 24" aria-hidden="true" {...rest}>
      <path
        fillRule="evenodd"
 ...
 */
export const InstagramSvgImage = (rest: SharedSvgImageProps) => {
  return (
    <SharedSvgImage viewBox="0 0 24 24" aria-hidden="true" {...rest}>
 ...
 */
export const LinkSvgImage = (rest: SharedSvgImageProps) => {
  return (
    <SharedSvgImage viewBox="0 0 24 24" aria-hidden="true" {...rest}>
      <path
 ...
 */
export const LinkedInSvgImage = (rest: SharedSvgImageProps) => {
  return (
    <SharedSvgImage viewBox="0 0 24 24" aria-hidden="true" {...rest}>
 ...
 */
export const MailSvgImage = (rest: SharedSvgImageProps) => {
  return (
    <SharedSvgImage
      viewBox="0 0 24 24"
      fill="none"
 ...
 */
export const MoonSvgImage = (rest: SharedSvgImageProps) => {
  return (
    <SharedSvgImage viewBox="0 0 24 24" aria-hidden="true" {...rest}>
      <path
 ...
 */
export const SunSvgImage = (rest: SharedSvgImageProps) => {
  return (
    <SharedSvgImage
      viewBox="0 0 24 24"
      strokeWidth="1.5"
 ...
 */
export const TwitterSvgImage = (rest: SharedSvgImageProps) => {
  return (
    <SharedSvgImage viewBox="0 0 24 24" aria-hidden="true" {...rest}>
