...
export type PageTopSectionFields_ComponentDuplex_Fragment = {
  __typename: 'ComponentDuplex'
}

export type PageTopSectionFields_ComponentHeroBanner_Fragment = {
  __typename: 'ComponentHeroBanner'
}

export type PageTopSectionFields_ComponentInfoBlock_Fragment = {
  __typename: 'ComponentInfoBlock'
}

export type PageTopSectionFields_ComponentQuote_Fragment = {
  __typename: 'ComponentQuote'
}

export type PageTopSectionFields_ComponentTextBlock_Fragment = {
...
export type PageContentFields_ComponentProductTable_Fragment = {
  __typename: 'ComponentProductTable'
}

export type PageContentFields_TopicBusinessInfo_Fragment = {
  __typename: 'TopicBusinessInfo'
}

export type PageContentFields_TopicProduct_Fragment = {
...
export type PageExtraSectionItemFields_ComponentCta_Fragment = {
  __typename: 'ComponentCta'
}

export type PageExtraSectionItemFields_ComponentDuplex_Fragment = {
  __typename: 'ComponentDuplex'
}

export type PageExtraSectionItemFields_ComponentHeroBanner_Fragment = {
  __typename: 'ComponentHeroBanner'
}

export type PageExtraSectionItemFields_ComponentInfoBlock_Fragment = {
  __typename: 'ComponentInfoBlock'
}

export type PageExtraSectionItemFields_ComponentQuote_Fragment = {
  __typename: 'ComponentQuote'
}

export type PageExtraSectionItemFields_ComponentTextBlock_Fragment = {
  __typename: 'ComponentTextBlock'
}
...
useCtfPageQuery.fetcher = (
  ...
  ctfFetcher<CtfPageQuery, CtfPageQueryVariables>(
    CtfPageDocument,
    variables,
    options
  )
