...
import { Path } from '@guy-romelle-magayano/react-components'
...
/**
 * Renders the language selector feature component.
 * @returns The rendered feature component.
 */
const LanguageSelectorFeature = () => {
  ...
  return locales && locales?.length > 1 ? (
    <Div className={classes.localeMenu}>
      <SvgIcon>
        {/* TODO: Add generic `g` React component */}
        ...
        {/* TODO: Add generic `defs` React component */}
        <defs>
...
LanguageSelectorFeature.displayName = 'LanguageSelectorFeature'

export default LanguageSelectorFeature
