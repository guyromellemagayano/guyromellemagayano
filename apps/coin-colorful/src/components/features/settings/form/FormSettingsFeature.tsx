...
import { Form } from '@guy-romelle-magayano/react-components'
import {
  Div,
  Footer,
  Header,
...
import { SettingsIcon } from '@guy-romelle-magayano/coin-colorful/components'
...
export type FormSettingsFeatureProps = {
  onClose: () => void
}
...
const FormSettingsFeature = (props: FormSettingsFeatureProps) => {
  ...
  const router = useRouter(),
    ...
    [newPreviewActive, setNewPreviewActive] = useState(previewActive || false),
...
FormSettingsFeature.displayName = 'FormSettingsFeature'

export default FormSettingsFeature
