...
import ArticlesList from '@guy-romelle-magayano/portfolio/components/list/Articles'

import { TArticlesData } from '@guy-romelle-magayano/portfolio/data/articles'
