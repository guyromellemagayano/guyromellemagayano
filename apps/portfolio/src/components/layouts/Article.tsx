...
import ArrowLeftSvgImage from '@guy-romelle-magayano/portfolio/components/images/svg/ArrowLeft'
import Prose from '@guy-romelle-magayano/portfolio/components/Prose'

import { formatDate } from '@guy-romelle-magayano/portfolio/utils/formatDate'

import type { TWithChildren } from '@guy-romelle-magayano/portfolio/types/common'
