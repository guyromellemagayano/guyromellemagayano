...
const HomeArticleLayout = dynamic(() =>
  import('@guy-romelle-magayano/portfolio/components/Article').then(
    mod => mod.Article
  )
)
const BaseContainer = dynamic(() =>
  import('@guy-romelle-magayano/portfolio/components/Containers/Base').then(
    mod => mod.BaseContainer
  )
)
const Prose = dynamic(() =>
  import('@guy-romelle-magayano/portfolio/components/Prose').then(
    mod => mod.Prose
  )
)
const ArrowLeftSvg = dynamic(() =>
  import('@guy-romelle-magayano/portfolio/components/SVG').then(
    mod => mod.ArrowLeftSvg
  )
)
