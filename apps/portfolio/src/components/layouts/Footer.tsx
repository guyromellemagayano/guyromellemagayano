...
import NavLink from '@guy-romelle-magayano/portfolio/components/NavLink'

import type { TNavigationData } from '@guy-romelle-magayano/portfolio/data/navigation'
import { TPagesPages } from '@guy-romelle-magayano/portfolio/data/pages'
