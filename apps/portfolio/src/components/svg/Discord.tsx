...
/**
 * Renders an SVG image of a Discord logo.
 * @param rest - Additional SVG props
 * @returns The rendered SVG image of a Discord logo.
 */
const DiscordSvg = memo(({ ...rest }: TSvgProps) => {
  return (
    <Svg aria-hidden="true" fill="currentColor" viewBox="0 0 640 512" {...rest}>
...
DiscordSvg.displayName = 'DiscordSvg'
