                ...
                return (
                  ...
                  >
                    <img
                      alt={imageAlt}
                      src={imageSrc}
                      className="md:h-18 mx-auto h-16 w-20 md:h-20 md:w-24"
                    />
                    <h3 className="mt-6 text-center text-base font-semibold leading-5 tracking-tighter text-zinc-600 dark:text-zinc-400">
                      {skill.name}
                    </h3>
                    <ul
                      role="list"
