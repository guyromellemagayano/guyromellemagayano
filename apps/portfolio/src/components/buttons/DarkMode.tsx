...
import MoonSvgImage from '@guy-romelle-magayano/portfolio/components/images/svg/Moon'
import SunSvgImage from '@guy-romelle-magayano/portfolio/components/images/svg/Sun'
