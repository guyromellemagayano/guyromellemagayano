...
/**
 * Creates a list-item that opens a *singleton* document
 * (ID === schema type).
 * Perfect for resources like *Home Page* or *Settings*.
 */
...
/**
 * Generates a two-item sub-menu:
 *
 * • **Index** singleton (first item)
 * • Orderable list of children (second item)
 *
 * Used for **Blog → Blog Index + Blogs** (drag-to-reorder).
 */
const createIndexListWithOrderableItems = ({
  ...
  list,
  context,
}: CreateIndexList): ListItemBuilder => {
