...
export const SkillsList = ({
    children,
    ...rest
}: IChildrenProps & any): React.ReactNode => {
    return (
        <Section {...rest}>
...
export const SkillsListCards = ({
    ...
    technologies,
    cta,
}: ISkillsListCardsProps): React.ReactNode => {
    return (
        <Card as="article">
...
export const ToolsListCards = ({
    title,
    description,
}: IUsesToolsItemsData): React.ReactNode => {
    return (
        <Card as="li">
...
export const ProjectsListCards = ({
    project,
}: IProjectListCardProps): React.ReactNode => {
    return (
...
export const WorkListCards = ({
    company,
    country,
    contributions,
    skills,
}: IWorkListData): React.ReactNode => {
    return (
        <Card as="article">
