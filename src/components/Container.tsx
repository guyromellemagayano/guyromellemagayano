...
const OuterContainer = React.forwardRef<DivRef, IContainerProps & any>(
...
const InnerContainer = React.forwardRef<DivRef, IContainerProps & any>(
...
// Container with ref
const ContainerWithRef = React.forwardRef<DivRef, IContainerProps & any>(
    function ContainerWithRef({ children, ...rest }, ref): React.ReactNode {
        return (
