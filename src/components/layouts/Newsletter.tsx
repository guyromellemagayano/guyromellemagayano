import { MailSvgIcon, MainButton } from '@/components'

// Newsletter form
const NewsletterLayout = (): React.ReactNode => {
    return (
        <form action="/thank-you" className="rounded-2xl border border-zinc-100 p-6 dark:border-zinc-700/40">
            <h2 className="flex text-sm font-semibold text-zinc-900 dark:text-zinc-100">
                <MailSvgIcon className="h-6 w-6 flex-none" />
            ...
            <div className="mt-6 flex">
                ...
                />
                <MainButton type="submit" className="ml-4 flex-none">
                    Join
                </MainButton>
            </div>
        </form>
