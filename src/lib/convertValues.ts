...
export const convertStringToNumber = (e: string): string | number =>
    !isEmpty(e) ? _.toNumber(e) : e

// Convert string to boolean
export const convertStringToBoolean = (e: string): string | boolean =>
    !isEmpty(e) ? e === 'true' : e

// Convert string to array
export const convertStringToArray = (e: string): string | any[] =>
    !isEmpty(e) ? _.toArray(e) : e

// Convert string to object
export const convertStringToObject = (e: string): string | object =>
    !isEmpty(e) ? JSON.parse(e) : e

// Convert object to string
export const convertObjectToString = (e: object): object | string =>
    !isEmpty(e) ? JSON.stringify(e) : e

// Convert array to string
export const convertArrayToString = (e: any[]): string | any[] =>
    !isEmpty(e) ? _.join(e, ' ') : e

// Convert number to string
export const convertNumberToString = (e: number): string | number =>
    !isEmpty(e) ? _.toString(e) : e

// Convert string to HTML
export const convertStringToHTML = (e: string): string | React.ReactNode =>
    !isEmpty(e) ? _.unescape(e) : e
