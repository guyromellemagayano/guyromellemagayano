...
interface SharedFooterProps extends React.HTMLAttributes<SharedFooterRef> {}
 ...
 */
export const SharedFooter = React.forwardRef<
  SharedFooterRef,
  SharedFooterProps
>(({ children, ...rest }, ref: React.ForwardedRef<SharedFooterRef>) => {
