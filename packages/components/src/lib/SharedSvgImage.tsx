...
export type TSharedSvgImageProps = SVGProps<SVGSVGElement> &
 ...
 */
export const ArrowDownSvgImage = (rest: TSharedSvgImageProps) => {
  return (
    <SharedSvgImage
      viewBox="0 0 16 16"
      fill="none"
 ...
 */
export const ArrowLeftSvgImage = (rest: TSharedSvgImageProps) => {
  return (
    <SharedSvgImage
      viewBox="0 0 16 16"
      fill="none"
 ...
 */
export const BriefcaseSvgImage = (rest: TSharedSvgImageProps) => {
  return (
    <SharedSvgImage
      viewBox="0 0 24 24"
      fill="none"
 ...
 */
export const ChevronDownSvgImage = (rest: TSharedSvgImageProps) => {
  return (
    <SharedSvgImage viewBox="0 0 8 6" aria-hidden="true" {...rest}>
      <path
 ...
 */
export const ChevronRightSvgImage = (rest: TSharedSvgImageProps) => {
  return (
    <SharedSvgImage
      viewBox="0 0 16 16"
      fill="none"
 ...
 */
export const CloseSvgImage = (rest: TSharedSvgImageProps) => {
  return (
    <SharedSvgImage viewBox="0 0 24 24" aria-hidden="true" {...rest}>
      <path
 ...
 */
export const GitHubSvgImage = (rest: TSharedSvgImageProps) => {
  return (
    <SharedSvgImage viewBox="0 0 24 24" aria-hidden="true" {...rest}>
      <path
        fillRule="evenodd"
 ...
 * @param rest - Additional SVG props.
 * @returns The rendered SVG image of the Instagram logo.
 */
export const InstagramSvgImage = (rest: TSharedSvgImageProps) => {
  return (
    <SharedSvgImage viewBox="0 0 24 24" aria-hidden="true" {...rest}>
 ...
 */
export const LinkSvgImage = (rest: TSharedSvgImageProps) => {
  return (
    <SharedSvgImage viewBox="0 0 24 24" aria-hidden="true" {...rest}>
      <path
 ...
 * @param rest - Additional SVG props
 * @returns The rendered SVG image of the LinkedIn logo.
 */
export const LinkedInSvgImage = (rest: TSharedSvgImageProps) => {
  return (
    <SharedSvgImage viewBox="0 0 24 24" aria-hidden="true" {...rest}>
 ...
 */
export const MailSvgImage = (rest: TSharedSvgImageProps) => {
  return (
    <SharedSvgImage
      viewBox="0 0 24 24"
      fill="none"
 ...
 */
export const MoonSvgImage = (rest: TSharedSvgImageProps) => {
  return (
    <SharedSvgImage viewBox="0 0 24 24" aria-hidden="true" {...rest}>
      <path
 ...
 */
export const SunSvgImage = (rest: TSharedSvgImageProps) => {
  return (
    <SharedSvgImage
      viewBox="0 0 24 24"
      strokeWidth="1.5"
 ...
 */
export const TwitterSvgImage = (rest: TSharedSvgImageProps) => {
  return (
    <SharedSvgImage viewBox="0 0 24 24" aria-hidden="true" {...rest}>
...
export const SharedSvgImage = ({ children, ...rest }: TSharedSvgImageProps) => {
