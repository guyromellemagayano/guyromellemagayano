import { type EmbedHTMLAttributes, lazy, Suspense } from "react";
...
export type EmbedRef = HTMLEmbedElement;
export type EmbedProps = EmbedHTMLAttributes<EmbedRef> & CommonComponentProps;
